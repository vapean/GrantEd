...
export class UsuariosService {
  ...
  obtenerPaisesHispanos() {
    return this.arrCountriesHispanos =
      [
        {
          "nombre": "Argentina",
          "name": "Argentina",
  ...
  obtenerNiveles() {
    return this.arrLevels = ['Concursos', 'Curso corto', 'Doctorado', 'Formación Profesional', 'Fellowship', 'Idiomas', 'Máster', 'Postdoctorado', 'Práctica', 'Grado Universitario', 'Residencia artística', 'Otros']
  }

  obtenerGeneros() {
    return this.arrGenders = ['Hombre', 'Mujer', 'Otro']
  }
